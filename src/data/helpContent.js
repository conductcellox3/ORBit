export const HelpContent = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "ノートの複製 (コピー)",
        description: "今あるノートと同じ内容・サイズのものをもう一つ作りたいときは、ノートを選択してショートカットキーを押すと即座に複製されます。また、ノートを選択した状態で「Alt(Option)」キーを押しながらドラッグすることでも複製が可能です。",
        shortcuts: ["複製する：Ctrl/Cmd + D"]
      }
    ]
  },
  {
